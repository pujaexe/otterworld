...
export type GitbookSvgrepoComsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function GitbookSvgrepoComsvgIcon(props: GitbookSvgrepoComsvgIconProps) {
...
export default GitbookSvgrepoComsvgIcon;
/* prettier-ignore-end */
